...
\printindex
 ...
 % 筆者が NOIR というアニメを最初に知ったのは、2017年8月ごろだったと記憶しています。ラテン語の曲を探していたら、偶然 Salva nos という戦闘曲にあたり、そこから NOIR というアニメを知りました。その後2017年10月に、NOIRの主人公の夕叢霧香 (ゆうむらきりか) のなりきりアカウントを作り、活動をはじめました。なりきりアカウントを作ったおかげで、精進が進んだように思われます。また、整数論テクニック集を作るに至ったきっかけも、なりきりアカウントでの会話がきっかけだったので、これなしでは本稿は存在し得なかったでしょう。
